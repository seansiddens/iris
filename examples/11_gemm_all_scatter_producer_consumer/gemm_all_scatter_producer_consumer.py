...
@triton.jit()
def persistent_all_scatter_spatial(
    C,
    locks,
    M,
    N,
    ...
    # pid0_xcd = (xcd_id - pid) % NUM_XCDS
    # shift = (gemm_xcd_start - pid0_xcd) % NUM_XCDS
    # new_pid = (pid + shift) % COMM_SMS
    ...
    COMM_SMS_PER_XCD = COMM_SMS // NUM_XCDS
